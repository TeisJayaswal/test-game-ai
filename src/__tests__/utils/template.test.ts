...
describe('template utils', () => {
  ...
  describe('hashFile', () => {
    ...
    beforeEach(() => {
      testDir = fs.mkdtempSync(path.join(os.tmpdir(), 'game-ai-hash-test-'));
    });
  ...
  describe('getFilesRecursive', () => {
    ...
    beforeEach(() => {
      testDir = fs.mkdtempSync(path.join(os.tmpdir(), 'game-ai-files-test-'));
    });
  ...
  describe('writeHashes and readHashes', () => {
    ...
    beforeEach(() => {
      testDir = fs.mkdtempSync(path.join(os.tmpdir(), 'game-ai-hashes-test-'));
    ...
    it('should write and read hashes correctly', () => {
      ...
      expect(hashes).toHaveProperty('test.md');
  ...
  describe('writeCommandsVersion and getCommandsVersion', () => {
    ...
    beforeEach(() => {
      testDir = fs.mkdtempSync(path.join(os.tmpdir(), 'game-ai-version-test-'));
      fs.mkdirSync(path.join(testDir, '.claude'));
    });
  ...
  describe('areCommandsOutdated', () => {
    ...
    beforeEach(() => {
      testDir = fs.mkdtempSync(path.join(os.tmpdir(), 'game-ai-outdated-test-'));
    });
  ...
  describe('compareWithTemplate', () => {
    ...
    beforeEach(() => {
      testDir = fs.mkdtempSync(path.join(os.tmpdir(), 'game-ai-compare-test-'));
      templateDir = fs.mkdtempSync(path.join(os.tmpdir(), 'game-ai-template-test-'));
